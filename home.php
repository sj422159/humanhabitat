        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="./hm,abt,con\about.php">About Us</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="./hm,abt,con\contactus.php">Contact Us</a>
              </li>
            ...
            <li class="nav-item dropdown">
                            ...
                            {
                              echo "<li><a class='dropdown-item' href='./partials/login.php'>Small Claim Bench</a></li>";
                            }
                            else
                            {
                              echo "<li><a class='dropdown-item' href='./small claim bench/form.php'>Small Claim Bench</a></li>";
                            }
                          ?> 
                          ...
                          <?php
                            if(!isset($_SESSION['username']))
                            {
                              echo "<li><a class='dropdown-item' href='./partials/login.php'>MSME Bench</a></li>";
                            }
                            else
                            {
                              echo "<li><a class='dropdown-item' href='./msme/form.php'>MSME Bench</a></li>";
                            }
                          ?>
                        ...
                        <?php
                            if(!isset($_SESSION['username']))
                            {
                              echo "<li><a class='dropdown-item' href='./partials/login.php'>Mediation Bench</a></li>";
                            }
                            else
                            {
                              echo "<li><a class='dropdown-item' href='./mediation/form.php'>Mediation Bench</a></li>";
                            }
                          ?>
                        ...
                        <?php
                            if(!isset($_SESSION['username']))
                            {
                              echo "<li><a class='dropdown-item' href='./partials/login.php'>Lok Adalat</a></li>";
                            }
                            else
                            {
                              echo "<li><a class='dropdown-item' href='./lokadalat/form.php'>Lok Adalat</a></li>";
                            }
                          ?>
                        ...
                        <?php
                            if(!isset($_SESSION['username']))
                            {
                              echo "<li><a class='dropdown-item' href='./partials/login.php'>Arbitration</a></li>";
                            }
                            else
                            {
                              echo "<li><a class='dropdown-item' href='./arbitration/form.php'>Arbitration</a></li>";
                            }
                          ?>
                        ...
                        <?php
                            if(!isset($_SESSION['username']))
                            {
                              echo "<li><a class='dropdown-item' href='./partials/login.php'>Conciliation Bench</a></li>";
                            }
                            else
                            {
                              echo "<li><a class='dropdown-item' href='./conciliation/form.php'>Conciliation Bench</a></li>";
                            }
                          ?>
                        ...
                        <?php
                            if(!isset($_SESSION['username']))
                            {
                              echo "<li><a class='dropdown-item' href='./partials/login.php'>odr Bench</a></li>";
                            }
                            else
                            {
                              echo "<li><a class='dropdown-item' href='./odr/form.php'>ODR</a></li>";
                            }
                          ?>                      
                      ...
                      <?php
                        ...
                        <?php
                            ...
                            {
                              echo "<button class='btn btn-success ms-2' type='submit'><a href='./index.php'>Logout</a></button>";
                            }
...
<div class="about">
  ...
  <button> <a href="hm,abt,con\about.php">About Us</a></button>
</div>

<div class="contact">
  <h2>Contact Us </h2>
  <p>Content Goes Here</p>
 <button><a href="hm,abt,con\contactus.php">Contact Us</a></button>
</div>



<a href="./discussion forum\index.php"><button id="chatButton"> <img src="./chat.png" alt="Chat" srcset=""></button></a>         
